									...
									<div class="panel-body registration-box">
										...
										<div class="col-md-12">
											<div class="form-group has-feedback">
												...
												<input type="text" class="form-control custom-input" placeholder="Choose username" name="Username">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group has-feedback">
													...
													<input type="text" class="form-control custom-input" placeholder="First name" name="FirstName">
										...
										<div class="row">
											...
											<div class="col-md-6">
												<div class="form-group has-feedback">
													...
													<input type="password" class="form-control custom-input" placeholder="Repeat password" name="ConfirmPassword">
												</div>
											</div>
										</div>
