        ...
        <div class="row adjustment" style="margin-top: 50px;">
            <div class="col-md-12 zeropadding">
              ...
              <div class="right-sidebar zeropadding">
                  ...
                  <div class="">
                    <h2 class="add-btn"><a class="btn btn-default add-btn-custom" data-toggle="modal" data-target="#add-modal">Add a new course</a></h2>
                  </div>
                  ...
                  <div class="row admin-courses" style="padding-top: 10px">
                    ...
                    <div class="col-sm-6 col-md-4 ">
                      <div class="thumbnail">
                        ...
                        <div class="caption">
                          <h4 class="textcolor ellipsis_oneline">Shoreline Management</h4>
                          <p class="textcolor ellipsis_oneline">Dr. M. Verma<span class="alttextcolor"> | January 2017</span></p>
